...
function displayTitle(entry: WatchHistoryEntry, channels: { id: number; name: string }[], movies: { id: number; name: string }[]): string {
  ...
  if (entry.contentType === 'movie') {
    const m = movies.find((m) => m.id === entry.contentId);
